package com.example.shanmugarajjoveeinfo.pageflipjava.components.general;
...
//   }
    ...
    public static byte[] MACtobyteConverter(String MAC) {
        ...
        MAC = MAC.replaceAll(":", "");
        Log.d("ComponentLibrary.To", "MACtobyteConverter input ="+MAC);
