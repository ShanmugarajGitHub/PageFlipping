...
import com.example.shanmugarajjoveeinfo.pageflipjava.R;
import com.example.shanmugarajjoveeinfo.pageflipjava.components.general.ToolBox;
import com.example.shanmugarajjoveeinfo.pageflipjava.components.general.Validate;
import com.example.shanmugarajjoveeinfo.pageflipjava.components.ui.containers.interfaces.IViewObserver;
...
//	}
    ...
    protected View addAndMeasureChildHorizontal(final View child, final int layoutMode) {
        ...
        if (lp == null) {
            ...
            if(lp instanceof LoopLayoutParams) params = (LoopLayoutParams) lp;
